...
---------- 📄 📄 📄 Menu Report Stock Gudang 📄 📄 📄 ----------
    ...
    ''')
    user_input = input("Tampilan Stok Yang Ingin Dipilih (1-4) : ")
    ...
    if user_input == '1':
        ...
        def report_sub2():
            ...
            if kategori_ditemukan:
                ...
                for produk in data_stok_list:
                    if produk['Kategori'] == kategori_yang_dicari:
                        print(f"{produk['Kode Produk']: <10}|{(produk['Nama Produk']): <35}|{(produk['Kategori']): <15}|{str(produk['Unit']): <5}|{str(produk['Harga Satuan']): <10}")       
            else:
...
def menu_update():
    def update_sub1():
        while True:
            tampilan_data()
            item_updatestok = input("▣ Masukkan Nama Produk yang Ingin Anda update: ").title()
    ...
    Field yang ingin Anda Update (1-5): '''))
                    ...
                    if jenis_update == 1:
                        ...
                        def update_harga():
                            ...
                            tampilan_data()
                            print("Harga Satuan Produk Berhasil Diupdate.")
